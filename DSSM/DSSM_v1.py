...
feature_columns = [SparseFeat(name="u_age", voc_size=8,hash_size=None,share_embed=None, embed_dim=4, dtype='string'),
                   SparseFeat(name='u_gender',voc_size=4,hash_size=None,share_embed=None,embed_dim=4,dtype='string'),
                   SparseFeat(name='i_type',voc_size=4,hash_size=None,share_embed=None,embed_dim=4,dtype='string')
                    VarLenSparseFeat(name="i_topic", voc_size=700, hash_size=None, share_embed='topic_id', weight_name = None, combiner= 'sum', embed_dim=16, maxlen=3,dtype='string'),
                    VarLenSparseFeat(name="prefer_topic_3d", voc_size=700, hash_size=None, share_embed='topic_id', weight_name = 'prefer_topic_3d_weight', combiner= 'sum', embed_dim=16, maxlen=5,dtype='string'),
                    DenseFeat(name='item_embed',pre_embed='post_id', reduce_type=None, dim=128, dtype='float32'),
                    DenseFeat(name='uid_embed',pre_embed='click_seq_3d', reduce_type='mean', dim=128, dtype='float32'),
                   ]

# 用户特征及贴子特征
user_feature_columns_name = ["u_age", "u_gender", "prefer_topic_3d",'uid_embed']
item_feature_columns_name = ["i_type", "i_topic", 'item_embed']
...
DICT_CATEGORICAL = {"u_gender": [0,1,2],
                    "u_age": [0,1,2,3,4,5,6,7],
                    "i_type": [0,1,2,3]
                    }
...
COL_NAME = ['uid','post_id','click_seq_3d','prefer_topic_3d','u_gender','u_age','i_type','i_topic']
